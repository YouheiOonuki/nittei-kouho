// ===========================
// 日程調整 候補日ジェネレーター — 祝日データ（値・出典・確認日をセットで）
// 内閣府「国民の祝日」の CSV（syukujitsu.csv）から、対応する年の分だけを写したもの
...
(function (root) {
  ...
  var CONSTANTS = {
    CHECKED: '2026-09-23',                 // 下の出典と突き合わせた日
    ...
    SOURCE: {
      ...
      csv: 'https://www8.cao.go.jp/chosei/shukujitsu/syukujitsu.csv',   // 2026-09-23 に取得し、下の 54 日と完全に一致することを確認（CSV は 2027 年まで）
    },
    // 振替休日・国民の休日は「休日」
    HOLIDAYS: {
